...
test("sync projects crew mission and sprint metadata into runtime artifacts", () => {
  ...
  assert.match(claudeCrew, /mission: Deliver bounded v0\.7\.0 Expertise Engine evolution/)
  ...
  assert.match(opencodeCrew, /mission: Deliver bounded v0\.7\.0 Expertise Engine evolution/)
  assert.match(opencodeCrew, /target_release: v0\.7\.0/)
  assert.match(opencodeCrew, /instruction_block:/)
  assert.match(opencodeCrew, /sprint=v0\.7\.0-expertise-engine/)
  assert.match(hermesCrew, /mission: Deliver bounded v0\.7\.0 Expertise Engine evolution/)
  ...
  assert.match(piPrompt, /mission: Deliver bounded v0\.7\.0 Expertise Engine evolution/)
  ...
  assert.match(piPrompt, /control v0\.7\.0 scope/)
})
