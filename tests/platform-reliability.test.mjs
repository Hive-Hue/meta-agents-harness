...
test("sync projects crew mission and sprint metadata into runtime artifacts", () => {
  ...
  assert.match(opencodeCrew, /mission: Deliver bounded v0\.8\.0 Context Memory evolution/)
  assert.match(opencodeCrew, /target_release: v0\.8\.0/)
  assert.match(opencodeCrew, /instruction_block:/)
  assert.match(opencodeCrew, /sprint=v0\.8\.0-context-memory/)
  assert.match(hermesCrew, /mission: Deliver bounded v0\.8\.0 Context Memory evolution/)
  ...
  assert.match(hermesPrompt, /skills\/delegate-bounded\/SKILL.md/)
  assert.match(piPrompt, /mission: Deliver bounded v0\.8\.0 Context Memory evolution/)
  ...
  assert.match(piPrompt, /control v0\.8\.0 scope/)
  assert.match(codexPrompt, /skills\/context-memory\/SKILL\.md/)
  assert.match(kiloPrompt, /skills\/context-memory\/SKILL\.md/)
  assert.match(hermesLeadPrompt, /skills\/context-memory\/SKILL\.md/)
  assert.match(codexLeadPrompt, /skills\/context-memory\/SKILL\.md/)
  assert.match(kiloLeadPrompt, /skills\/context-memory\/SKILL\.md/)
})
