...
test("sync projects crew mission and sprint metadata into runtime artifacts", () => {
  ...
  assert.match(claudeCrew, /mission: Deliver bounded v0\.6\.0 runtime evolution/)
  ...
  assert.match(opencodeCrew, /mission: Deliver bounded v0\.6\.0 runtime evolution/)
  assert.match(opencodeCrew, /target_release: v0\.6\.0/)
  assert.match(opencodeCrew, /instruction_block:/)
  assert.match(opencodeCrew, /sprint=v0\.6\.0-headless-and-sessions/)
  assert.match(hermesCrew, /mission: Deliver bounded v0\.6\.0 runtime evolution/)
  ...
  assert.match(piPrompt, /mission: Deliver bounded v0\.6\.0 runtime evolution/)
  ...
  assert.match(piPrompt, /full multi-runtime parity/)
})
