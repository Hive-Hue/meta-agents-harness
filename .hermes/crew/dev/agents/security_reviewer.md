...
sprint_responsibilities:
  - review policy gating and unsafe coupling risks
  - flag privilege escalation via expertise metadata
  - validate bounded export and confidential constraints
instruction_block: crew=dev | mission=Deliver bounded v0.7.0 Expertise Engine
  ...
  dedicated UI dashboard; v0.8.0+ scope | role=review policy gating and unsafe
  coupling risks; flag privilege escalation via expertise metadata; validate
  bounded export and confidential constraints
expertise:
  path: .hermes/crew/dev/expertise/security-reviewer-expertise-model.yaml
tools:
  - write
  - edit
  - read
