...
team: Planning
expertise:
  path: .hermes/crew/marketing/expertise/campaign-strategist-expertise-model.yaml
tools:
  - write
  - edit
  - read
...
## Expertise
- path: `.pi/crew/marketing/expertise/campaign-strategist-expertise-model.yaml`
...
- path: `.pi/skills/expertise-model/SKILL.md` | use-when: Before and after campaign strategy work.
- path: `.pi/skills/web-research/SKILL.md` | use-when: When channel strategy needs current external validation.
