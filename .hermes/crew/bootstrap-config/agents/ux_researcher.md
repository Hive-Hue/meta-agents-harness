...
sprint_responsibilities:
  - design first-run questionnaire
...
instruction_block: crew=bootstrap-config | mission=Design and implement an
  ...
  needs; v0.5.0+ onboarding wizard scope | role=design first-run questionnaire;
  define prompt wording; reduce decision fatigue; propose smart defaults
expertise:
  path: .hermes/crew/bootstrap-config/expertise/ux-researcher-expertise-model.yaml
tools:
  - write
  - edit
  - read
