...
sprint_responsibilities:
  ...
  - decide required vs optional prompts
  - define AI-assisted UX boundaries
  - minimize operator friction
instruction_block: crew=bootstrap-config | mission=Design and implement an
  ...
  needs; v0.5.0+ onboarding wizard scope | role=define onboarding flow; decide
  required vs optional prompts; define AI-assisted UX boundaries; minimize
  operator friction
expertise:
  path: .hermes/crew/bootstrap-config/expertise/product-lead-expertise-model.yaml
tools:
  - read
  - grep
  - find
