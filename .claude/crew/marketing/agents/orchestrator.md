...
## Expertise
- path: `.claude/crew/marketing/expertise/orchestrator-expertise-model.yaml`
...
- path: `.claude/skills/expertise-model/SKILL.md` | use-when: At task boundaries to preserve durable learnings.
