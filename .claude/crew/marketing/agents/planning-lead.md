...
## Expertise
- path: `.claude/crew/marketing/expertise/planning-lead-expertise-model.yaml`
...
- path: `.claude/skills/expertise-model/SKILL.md` | use-when: Start and end of planning cycles.
