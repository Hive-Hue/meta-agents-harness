...
## Expertise
- path: `.claude/crew/marketing/expertise/creative-lead-expertise-model.yaml`
...
- path: `.claude/skills/expertise-model/SKILL.md` | use-when: Start and end of creative rounds.
