...
## Expertise
- path: `.claude/crew/marketing/expertise/validation-lead-expertise-model.yaml`
...
- path: `.claude/skills/expertise-model/SKILL.md` | use-when: Start and end of validation rounds.
