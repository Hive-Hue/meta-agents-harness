...
## Expertise
- path: `.opencode/crew/dev/expertise/validation-lead-expertise-model.yaml`
...
- path: `.opencode/skills/expertise-model/SKILL.md` | use-when: Start/end of validation rounds.
