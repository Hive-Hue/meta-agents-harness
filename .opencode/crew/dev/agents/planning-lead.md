...
## Expertise
- path: `.opencode/crew/dev/expertise/planning-lead-expertise-model.yaml`
...
- path: `.opencode/skills/expertise-model/SKILL.md` | use-when: Start/end of planning cycles.
