...
## Expertise
- path: `.opencode/crew/marketing/expertise/creative-strategist-mental-model.yaml`
- use-when: Preserve concept systems, visual direction, and content formats.

## Skills
- path: `.opencode/skills/mental-model/SKILL.md` | use-when: Before and after creative planning.
