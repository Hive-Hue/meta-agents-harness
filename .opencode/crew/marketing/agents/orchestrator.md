...
## Expertise
- path: `.opencode/crew/marketing/expertise/orchestrator-expertise-model.yaml`
...
- path: `.opencode/skills/expertise-model/SKILL.md` | use-when: At task boundaries to preserve durable learnings.
