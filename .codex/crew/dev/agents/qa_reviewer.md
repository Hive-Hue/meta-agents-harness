...
sprint_responsibilities:
  - run expertise unit, integration, and contract tests
  - run diagnostics and regression suites
  - verify sync consistency and output contracts
  - validate recommendation and delegation explain flows
instruction_block: crew=dev | mission=Deliver bounded v0.7.0 Expertise Engine
  ...
  dedicated UI dashboard; v0.8.0+ scope | role=run expertise unit, integration,
  and contract tests; run diagnostics and regression suites; verify sync
  consistency and output contracts; validate recommendation and delegation
  explain flows
expertise:
  path: .codex/crew/dev/expertise/qa-reviewer-expertise-model.yaml
tools:
  - write
  - edit
  - read
