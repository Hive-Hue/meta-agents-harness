...
instruction_block: crew=dev | mission=Advance runtime support, validation,
  ...
  | role=define phase gates; validate spec adherence; block scope escape from
