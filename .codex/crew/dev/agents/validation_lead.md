...
sprint_responsibilities:
  ...
  - enforce explicit fidelity and fallback rules
instruction_block: crew=dev | mission=Deliver bounded v0.6.0 runtime evolution
  ...
  broker; v0.7.0+ scope | role=define phase gates; validate spec adherence;
  block scope escape from the release boundary; enforce explicit fidelity and
  fallback rules
expertise:
  path: .codex/crew/dev/expertise/validation-lead-expertise-model.yaml
tools:
  - read
  - grep
  - find
