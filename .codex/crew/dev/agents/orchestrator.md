...
instruction_block: crew=dev | mission=Advance runtime support, validation,
  ...
  runtime capture by Hermes; defer anything outside v0.5.0
expertise:
  path: .codex/crew/dev/expertise/orchestrator-expertise-model.yaml
tools:
  - read
  - grep
  - find
