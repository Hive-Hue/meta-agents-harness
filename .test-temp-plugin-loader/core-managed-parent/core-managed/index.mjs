...
export const runtimePlugin = {
  ...
  adapter: {
    name: "core-managed",
    markerDir: ".core-managed",
    wrapper: null,
    directCli: "core-managed",
    capabilities: {
      sessionModeNew: true,
      sessionModeContinue: true,
      sessionModeNone: true,
      sessionIdViaEnv: "CORE-MANAGED_SESSION_ID",
    ...
    commands: {
      doctor: [["core-managed", ["doctor"]]],
      "check:runtime": [["core-managed", ["doctor"]]],
      validate: [["core-managed", ["doctor"]]],
      "validate:runtime": [["core-managed", ["doctor"]]]
    },
