...
export const runtimePlugin = {
  ...
  adapter: {
    ...
    capabilities: {
      ...
      sessionIdViaEnv: "DEDUP_SESSION_ID",
    ...
    commands: {
      "list:crews": [["dedupmh", ["list:crews"]]],
      use: [["dedupmh", ["use"]]],
      clear: [["dedupmh", ["clear"]]],
      run: [["dedupmh", ["run"]]],
      doctor: [["dedupmh", ["doctor"]]],
      "check:runtime": [["dedupmh", ["check:runtime"]]],
      validate: [["dedupmh", ["validate"]]],
      "validate:runtime": [["dedupmh", ["validate:runtime"]]]
    },
