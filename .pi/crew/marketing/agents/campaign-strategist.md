...
## Expertise
- path: `.pi/crew/marketing/expertise/campaign-strategist-mental-model.yaml`
...
- path: `.pi/skills/mental-model/SKILL.md` | use-when: Before and after campaign strategy work.
