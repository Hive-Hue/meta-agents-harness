...
team: Validation
expertise:
  path: .pi/expertise/validation-lead-mental-model.yaml
  use-when: Track regression patterns, review heuristics, and which validation combinations catch the highest-risk issues.
  updatable: true
  max-lines: 10000
tools:
  - delegate_agent
