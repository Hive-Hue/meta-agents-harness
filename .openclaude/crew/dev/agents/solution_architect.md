...
sprint_responsibilities:
  - define context memory document, index, and retrieval contracts
  - define bootstrap injection and explain payload semantics
  - define proposal governance and persistence envelope
instruction_block: crew=dev | mission=Deliver bounded v0.8.0 Context Memory
  ...
  scope | role=define context memory document, index, and retrieval contracts;
  define bootstrap injection and explain payload semantics; define proposal
  governance and persistence envelope
expertise:
  path: .openclaude/crew/dev/expertise/solution-architect-expertise-model.yaml
tools:
  - write
  - edit
  - read
