...
sprint_responsibilities:
  - run context unit, integration, and contract tests
  - run diagnostics and regression suites
  - verify sync consistency and output contracts
  - validate retrieval, bootstrap, and proposal explain flows
instruction_block: crew=dev | mission=Deliver bounded v0.8.0 Context Memory
  ...
  scope | role=run context unit, integration, and contract tests; run
  diagnostics and regression suites; verify sync consistency and output
  contracts; validate retrieval, bootstrap, and proposal explain flows
expertise:
  path: .openclaude/crew/dev/expertise/qa-reviewer-expertise-model.yaml
tools:
  - write
  - edit
  - read
