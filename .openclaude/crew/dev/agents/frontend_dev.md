...
sprint_responsibilities:
  - implement context CLI and help surfaces
  - improve operator-facing retrieval and proposal explainability outputs
  - keep UX legible for bounded context and bootstrap flows
instruction_block: crew=dev | mission=Deliver bounded v0.8.0 Context Memory
  ...
  scope | role=implement context CLI and help surfaces; improve operator-facing
  retrieval and proposal explainability outputs; keep UX legible for bounded
  context and bootstrap flows
expertise:
  path: .openclaude/crew/dev/expertise/frontend-dev-expertise-model.yaml
tools:
  - write
  - edit
  - read
